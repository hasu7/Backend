...
try {
  ...
  throw new ApiError(500, error.message || "Failed to upload files");
}
...
if (!isPasswordValid) {
  throw new ApiError(401,"Invalid User credeantials")
}
...
const updateAccountDetails=asyncHandler(async(req,res)=>{
  ...
  return res
  .status(200)
  .json(new ApiResponse(200,user,"Accoutn deatils updated successfully"))
